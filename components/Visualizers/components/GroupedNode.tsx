...
const GroupedNodeComponent = ({ data, id, isVisible = true }: NodeProps & { isVisible?: boolean }) => {
...
const GroupedNode = memo(GroupedNodeComponent);
GroupedNode.displayName = 'GroupedNode';
